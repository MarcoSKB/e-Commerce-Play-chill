...
const SearchForm: React.FC<Props> = (props) => {
  ...
  return (
    <form onSubmit={(e) => handlerSubmit(e)} onInput={() => onTypeInput()}>
      <input
        className={`absolute w-full md:min-h-16 text-base pl-6 md:py-5 md:pl-8 md:pr-[60px] focus:outline-none transition-colors duration-300 ${
          isOpen
      ...
      <button
        type="submit"
        className={`absolute z-20 lx:opacity-20 hover:opacity-50 transition-opacity focus:outline-none rounded-md focus-visible:outline-blue focus-visible:outline-offset-8 ${
          isOpen
