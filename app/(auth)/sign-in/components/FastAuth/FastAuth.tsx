...
const FastAuth = () => {
  ...
  return (
    <button
      ...
      className="flex items-center justify-center w-full py-3 px-4 text-blue text-base font-semibold border-solid border-[2px] border-white border-opacity-10 rounded-2xl transition-colors focus-visible:outline-none  hover:text-white focus-visible:outline-blue focus-visible:text-white disabled:focus-visible:text-gray-700 disabled:hover:text-gray-700 disabled:text-gray-700"
    >
